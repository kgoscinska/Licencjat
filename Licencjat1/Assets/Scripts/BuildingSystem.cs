...
public class BuildingSystem : MonoBehaviour
{
    ...
    {
        List<int> xs = allBuildingPosition.Select(preview => Mathf.FloorToInt(preview.x)).ToList();
        List<int> zs = allBuildingPosition.Select(preview => Mathf.FloorToInt(preview.x)).ToList();
    ...
    {
        BuildingPreview buildingPreview = Instantiate(preview, position, Quaternion.identity);
